...
public class Test016_JavaScript {
    ...
    public void registerAnUser(){
        try{
            ...
            txtFirstName.sendKeys("Barbara Mignoni");
            ...
            driver.findElement(By.id("email")).sendKeys("barbara@mail.cm");
